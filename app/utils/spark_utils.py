...
def initSpark():
    ...
    spark = SparkSession.builder.master("spark://" + spark_host + ":" + spark_port) \
        ...
        .config("spark.jars", "/opt/bitnami/spark/jars/mongo-spark-connector_2.12-3.0.1.jar,/opt/bitnami/spark/jars/mongo-java-driver-3.12.10.jar,/opt/bitnami/spark/jars/postgresql-42.3.0.jar,/opt/bitnami/spark/jars/monetdb-jdbc-3.2.jre8.jar") \
        .getOrCreate()
    return spark